...
const storage = multer.diskStorage({
  destination: function (req, file, cb) {
    ...
    let destinationPath = path.join('./dist/Archivos', proyecto, 'Propuesta'); //proyecto= nombre del proyecto, se necesita tener creada su carpeta
...
router.post('/:proyecto_id', upload.single('archivo'), (req, res) => {
